...
def cal_loss(model, images, labels, objectiness, class_im_plain, ignore_label):
    ...
    with tf.GradientTape() as tape:
        ...
        # no_obj_loss = false_dice_loss(no_obj_labels, no_logit_objectiness)
        no_obj_loss = tf.keras.losses.BinaryCrossentropy(from_logits=True)(no_obj_labels, no_logit_objectiness)
        ...
        # obj_loss = true_dice_loss(yes_obj_labels, yes_logit_objectiness)
        obj_loss = tf.keras.losses.BinaryCrossentropy(from_logits=True)(yes_obj_labels, yes_logit_objectiness)
        ...
        crop_dice_loss = tf.keras.losses.BinaryCrossentropy(from_logits=True)(crop_labels, crop_logits)
        #######################################
        ...
        non_crop_dice_loss = tf.keras.losses.BinaryCrossentropy(from_logits=True)(non_crop_labels, non_crop_logits)
        ###########################################
        ...
        weed_dice_loss = tf.keras.losses.BinaryCrossentropy(from_logits=True)(weed_labels, weed_logits)
        #######################################
        ...
        non_weed_dice_loss = tf.keras.losses.BinaryCrossentropy(from_logits=True)(non_weed_labels, non_weed_logits)
        ###########################################
